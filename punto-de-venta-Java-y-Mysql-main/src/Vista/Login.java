...
public class Login extends javax.swing.JFrame {
	...
	// Instancia del objeto de acceso a datos (DAO) para realizar el login
	LoginDAO login = new LoginDAO();

	// Temporizador para simular una barra de progreso
	private Timer tiempo;

	// Contador para la barra de progreso
	int contador;

	// Tiempo de intervalo para el temporizador (en milisegundos)
	int segundos = 30;

	// Constructor de la clase Login
	public Login() {
		initComponents(); // Inicializa los componentes visuales de la ventana
		this.setLocationRelativeTo(null); // Centra la ventana en la pantalla
		txtCorreo.setText("admin@gmail.com"); // Valor por defecto para pruebas
		txtPass.setText("admin"); // Valor por defecto para pruebas
		barra.setVisible(false); // Oculta la barra de progreso inicialmente
	}

	// Clase interna que gestiona el comportamiento del temporizador y la barra de
	// progreso
	public class BarraProgreso implements ActionListener {

		@Override
		public void actionPerformed(ActionEvent ae) {
			contador++; // Incrementa el contador en cada tick del temporizador
			barra.setValue(contador); // Actualiza el valor de la barra

			// Cuando la barra alcanza el 100%
			if (contador == 100) {
				tiempo.stop(); // Detiene el temporizador

				// Verifica que la barra esté llena antes de continuar
				if (barra.getValue() == 100) {
					// Abre el sistema principal pasando el usuario logueado
	...
	private void initComponents() {
		...
		jPanel4Layout.setVerticalGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel4Layout.createSequentialGroup().addGap(33, 33, 33).addComponent(jLabel1)
